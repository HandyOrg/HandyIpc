...
namespace HandyIpc.Server
{
    public class IpcServer
    {
        ...
        private readonly ConcurrentDictionary<Type, IIpcDispatcher> _ipcServerProxies = new ConcurrentDictionary<Type, IIpcDispatcher>();
...
#pragma warning restore 4014
        ...
        private IIpcDispatcher GetOrAddIpcServerProxy(Type interfaceType, Func<object> factory)
        {
            return _ipcServerProxies.GetOrAdd(interfaceType, key =>
            {
                ...
                return (IIpcDispatcher)Activator.CreateInstance(
